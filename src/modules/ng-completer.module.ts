...
export class NgCompleterModule {

    public static forRoot(): ModuleWithProviders<NgCompleterModule> {
        return {
            ngModule: NgCompleterModule,
            providers
        };
    }

    public static forChild(): ModuleWithProviders<NgCompleterModule> {
        return {
            ngModule: NgCompleterModule,
            providers
        };
